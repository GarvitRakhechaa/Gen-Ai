    ...
    [
        (
            ...
            """You are a twitter techie influencer assistant tasked with writing excellent twitter posts .
             ...
             generate only one tweeter post dont provide any type of variation 
             you have to generate strictly only one tweet
...
reflection_prompt = ChatPromptTemplate.from_messages(
    [
        (
            ...
            if tweet made good then provide this is done now you can tweet that ok
            just say twee
            """
        ),
